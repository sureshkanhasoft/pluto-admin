...
const CreateBooking = () => {
  ...
  const handleChangeCheck = (event) => {
    ...
    if (isChecked) {
      ...
      const newData = specialityData.speciality.filter(
  ...
  const getSpecialities = async () => {
    ...
    await axios
      .get(`${apiConfigs.API_URL}api/organization/get-spec-shift-create`, {
        headers: {
  ...
  const getTrust = async () => {
    ...
    await axios
      .get(`${apiConfigs.API_URL}api/organization/get-trusts`, {
        headers: {
          "content-type": "application/json",
          Authorization: `Bearer ${loggedInUser}`,
        },
  ...
  const gethospital = async () => {
    if (getTrustId) {
      ...
      await axios
        .get(
          `${apiConfigs.API_URL}api/organization/get-hospitallist/${getTrustId}`,
          {
            headers: {
              "content-type": "application/json",
              Authorization: `Bearer ${loggedInUser}`,
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} lg={4}>
              ...
              >
                ...
                >
                  <MenuItem value="">Select Trust</MenuItem>
                  {trust?.data &&
            ...
            <Grid item xs={12}>
              <FormControl
                ...
                className={classes.formControl}
              >
                {speciality?.data && speciality?.data.length > 0 && (
