        ...
        <Paper className={classes.root}>
          <form onSubmit={handleSubmit(submitData)} autoComplete="off">
            <Grid container spacing={2}>
                              ...
                              <FormControl
                                ...
                                error={
                                  ...
                                  errors.trust_portal_url
                                    ...
                                    : createTrustError &&
                                      createTrustError?.[
                                        `hospital.${index}.ward.${wIndex}.ward_type_id`
                                      ]
                                    ? true
                                    : false
                                }
              ...
              data.hospital[0].ward[0].ward_type_id !== "" &&
              data.hospital[0].ward[0].ward_number !== "" ? (
                <Grid item xs={12}>
                ...
                <TextField
                  ...
                  error={
                    errors.trust_portal_url
                      ? true
                      : createTrustError &&
                        createTrustError?.[`trust_portal_url`]
                      ? true
                      : false
                ...
                return (
                  ...
                  >
                    <TextField
                      ...
                      onChange={(e) =>
                        handleChangeHospital(index, e, "training")
                      }
                      fullWidth
                    />
                    {index !== 0 ? (
              ...
              <Grid item xs={12} sm={6} lg={3}>
                <TextField
                  ...
                  {...register("payable_night_rate", {
                    required: "Please enter night rate",
                  })}
              ...
              <Grid item xs={12} sm={6} lg={3}>
                <TextField
                  ...
                  {...register("payable_holiday_rate", {
                    required: "Please enter sunday rate",
                  })}
              ...
              <Grid item xs={12} sm={6} lg={3}>
                <TextField
                  ...
                  {...register("chargeable_saturday_rate", {
                    required: "Please enter Chargeable Saturday Rate",
                  })}
              ...
              <Grid item xs={12} sm={6} lg={3}>
                <TextField
                  ...
                  {...register("chargeable_holiday_rate", {
                    required: "Please enter Chargeable Holiday",
                  })}
